# Modified from https://github.com/Ice-Cirno/HoshinoBot/blob/master/hoshino
# /modules/priconne/_pcr_data.py
'''公主连接Re:dive的游戏数据'''
...
CHARA_ID = {
    '凯留': 1, 'キャル': 1, 'Karyl': 1, 'Kyaru': 1, '凯露': 1, '百地希留耶': 1,
    '希留耶': 1, 'Kiruya': 1, '黑猫': 1, '臭鼬': 1, '普黑': 1, '接头霸王': 1,
    '街头霸王': 1, '猫猫': 1,
    '初音': 3, 'ハツネ': 3, 'Hatsune': 3, 'hego': 3, '星法': 3, '星星法': 3,
    '⭐法': 3, '睡法': 3, '拍大星': 3,
    '杏奈': 5, 'アンナ': 5, 'Anna': 5, '中二': 5, '煤气罐': 5,
    '优妮': 7, 'ユニ': 7, 'Yuni': 7, '真行寺由仁': 7, '由仁': 7, '优尼': 7,
    'u2': 7, '优妮辈先': 7, '辈先': 7, '书记': 7, 'uni': 7, '先辈': 7,
    '仙贝': 7, '油腻': 7, '优妮先辈': 7, '学姐': 7, '18岁黑丝学姐': 7,
    '琪爱儿': 9, 'チエル': 9, 'Chieru': 9, '切露': 9, '茄露': 9, '茄噜': 9,
    '切噜': 9,
    '克萝依': 11, 'ク ロエ': 11, 'Kuroe': 11, '华哥': 11, '黑江': 11,
    '黑江花子': 11, '花子': 11,
    '静 流': 13, 'シズル': 13, 'Shizuru': 13, '姐姐': 13,
    '惠理子': 15, 'エリコ': 15, 'Eriko': 15, '病娇': 15,
    '优花梨': 17, 'ユカリ': 17, 'Yukari': 17, '由加莉': 17, '黄骑': 17,
    '酒鬼': 17, '奶骑': 17, '圣骑': 17, '🍺': 17, '🍺👻': 17, '油咖喱': 17,
    '空花': 19, 'クウカ': 19, 'Kuuka': 19, '抖m': 19, '抖': 19,
    '忍': 21, 'シノブ': 21, 'Shinobu': 21, '普忍': 21, '鬼父': 21, '💀': 21,
    '真步': 23, 'マホ': 23, 'Maho': 23, '狐狸': 23, '真扎': 23, '咕噜灵波': 23,
    '真布': 23, '🦊': 23,
    '茜里': 25, 'アカリ': 25, 'Akari': 25, '妹法': 25, '妹妹法': 25,
    '镜华': 27, 'キョウカ': 27, 'Kyouka': 27, '小仓唯': 27, 'xcw': 27,
    '小苍唯': 27, '8岁': 27, '八岁': 27, '喷水萝': 27, '八岁喷水萝': 27,
    '8岁喷水萝': 27,
    '美美': 29, 'ミミ': 29, 'Mimi': 29, '兔子': 29, '兔兔': 29, '兔剑': 29,
    '萝卜霸断剑': 29, '人参霸断剑': 29, '天兔霸断剑': 29, '🐇': 29, '🐰': 29,
    '禊': 31, 'ミソギ': 31, 'Misogi': 31, '未 奏希': 31, '炸弹': 31,
    '炸弹人': 31, '💣': 31,
    '怜': 33, 'レイ': 33, 'Rei': 33, '剑圣': 33, '普怜': 33, '伶': 33,
    '优衣': 35, 'ユイ': 35, 'Yui': 35, '种田': 35, '普田': 35, '由衣': 35,
    '结衣': 35, 'ue': 35, '↗↘↗↘': 35,
    '日和': 37, 'ヒヨリ': 37, 'Hiyori': 37, '日和莉': 37, '猫拳': 37,
    '🐱👊': 37, '贪吃佩可': 39, 'ペコリーヌ': 39, 'Pecorine': 39,
    'Pekoriinu': 39, '佩可莉姆': 39, '吃货': 39, '佩可': 39, '公主': 39,
    '饭团': 39, '🍙': 39,
    '可可萝': 41, 'コッコロ': 41, 'Kokkoro': 41, '可可罗': 41, '妈': 41,
    '普白': 41, '普妈': 41,
    '璃乃': 43, 'リノ': 43, 'Rino': 43, '妹弓': 43,
    '克莉丝提娜': 45, 'クリスティーナ': 45, 'Kurisutiina': 45, ' 誓约女君': 45,
    '克莉丝提娜·摩根': 45, 'Christina': 45, 'Cristina': 45, '克总': 45,
    '女帝': 45, '克': 45, '摩根': 45,
    '栞': 47, 'シオリ': 47, 'Shiori': 47, 'tp弓': 47, '小栞': 47, '白虎弓': 47,
    '白虎妹': 47,
    '铃奈': 49, 'スズナ': 49, 'Suzuna': 49, '暴击弓': 49, '暴弓': 49,
    '爆击弓': 49, '爆弓': 49, '政委': 49,
    '咲恋': 51, 'サレン': 51, 'Saren': 51, '充电宝': 51, '青梅竹马': 51,
    '幼驯染': 51, '院长': 51, '园长': 51, '🔋': 51, '普电': 51,
    '露娜': 53, 'ルナ': 53, 'Runa': 53, 'Luna': 53, '露仓唯': 53, '露cw': 53,
    '霞': 55, 'カスミ': 55, 'Kasumi': 55, '香澄': 55, '侦探': 55, '杜宾犬': 55,
    '驴': 55, '驴子': 55, '🔍': 55,
    '真琴': 57, 'マコ ト': 57, 'Makoto': 57, '狼': 57, '🐺': 57, '月月': 57,
    '朋': 57, '狼姐': 57,
    '香织': 59, 'カオリ': 59, 'Kaori': 59, '琉球犬': 59, '狗子': 59, '狗': 59,
    '狗拳': 59, '🐶': 59, '🐕': 59, '🐶👊🏻': 59, '🐶👊': 59,
    '亚里莎': 61, 'アリサ': 61, 'Arisa': 61, '鸭梨瞎': 61, '瞎子': 61,
    '亚里沙': 61, '鸭梨傻': 61, '亚丽莎': 61, '亚莉莎': 61, '瞎子弓': 61,
    '🍐🦐': 61, 'yls': 61,
    '望': 63, 'ノゾミ': 63, 'Nozomi': 63, '偶像': 63, '小望': 63, '🎤': 63,
    '拉比林斯达': 65, 'ラビリスタ': 65, 'Rabirisuta': 65, '迷宫女王': 65,
    '模索路晶': 65, '模索路': 65, '晶': 65, '迷宫女': 65, '王晶': 65,
    '晶姐': 65, '日日日': 65
}
